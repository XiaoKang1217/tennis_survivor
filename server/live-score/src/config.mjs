...
export function loadConfig(env = process.env) {
  return {
    ...
    fixturesTtlMs: Number(env.FIXTURES_TTL_MS || 30 * 60_000),
    unresolvedFixturesTtlMs: Number(env.UNRESOLVED_FIXTURES_TTL_MS || 5 * 60_000),
    futureFixturesTtlMs: Number(env.FUTURE_FIXTURES_TTL_MS || 60 * 60_000),
