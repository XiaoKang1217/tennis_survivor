...
async function main() {
  ...
  const common = {
    ...
    submission_cutoff_at: '2026-08-02T22:15:00+08:00',
    submission_closes_at: '2026-08-02T22:15:00+08:00',
  ...
  const active = {
    ...
    notes: [
      ...
      '本站签约金 1000；开售时间为北京时间 2026-08-01 00:00 至 2026-08-02 22:15；换人窗口和男女互换规则待确认。',
